...
**Last updated:** 2026-05-24 06:49 UTC
**Tested tt-metal:** [`main@509dd0d`](https://github.com/tenstorrent/tt-metal/commit/509dd0df2d973ff01ddd16c8c9cf472ede43d8ba)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Linux Mint 22.2 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Linux Mint 22.1 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Linux Mint 21.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([4 patches](patches/ubuntu/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Debian 13 | ❌(deps) | ✅ ([6 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Debian 12 | ❌(deps) | ✅ ([6 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Rocky Linux 10 | ✅ | ✅ ([1 patch](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Rocky Linux 9 | ✅ | ✅ ([1 patch](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Linux Mint 22.2 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Linux Mint 22.1 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Linux Mint 21.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Ubuntu 26.04 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Debian 13 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Debian 12 | ❌(install) (`v2.2.1`) | ❌(install) (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Rocky Linux 10 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
| Rocky Linux 9 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) |
<!-- INSTALL_TABLE_END -->
...
|---|---|---|---:|---:|---:|---|
| [26353597992](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/26353597992) | 2026-05-24 | `main@509dd0d` | 9/9 | 8/9 | 9/9 | Debian 12 install |
| [25999347485](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25999347485) | 2026-05-17 | `main@55c6b35` | 9/9 | 8/9 | 8/9 | Debian 12 install, Ubuntu 26.04 runtime (runtime) |
| [25916683483](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25916683483) | 2026-05-15 | `main@4a69f05` | 9/9 | 8/9 | 8/9 | Debian 12 install, Ubuntu 26.04 runtime (runtime) |
| [25914715257](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) | 2026-05-15 | `main@4a69f05` | 9/9 | 8/9 | 8/9 | Debian 12 install, Ubuntu 26.04 runtime (runtime) |
| [25814717283](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25814717283) | 2026-05-13 | `main@f0915a3` | 9/9 | 8/9 | 0/9 | Debian 12 install, Linux Mint 22.3 runtime (runtime), Linux Mint 22.2 runtime (runtime), +7 more |
<!-- HISTORY_SUMMARY_END -->
