...
**Tested tt-metal:** [`main@35a716c`](https://github.com/tenstorrent/tt-metal/commit/35a716ccced50430fe24c22c6e5258ee48b9a89e)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Linux Mint 22.2 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Linux Mint 22.1 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Linux Mint 21.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([3 patches](patches/ubuntu/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Debian 13 | ❌(deps) | ✅ ([4 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Debian 12 | ❌(deps) | ✅ ([4 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Rocky Linux 10 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Rocky Linux 9 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Linux Mint 22.2 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Linux Mint 22.1 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Linux Mint 21.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Ubuntu 26.04 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Debian 13 | ✅ (`v3.4.0`) | ❌(install) ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Debian 12 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Rocky Linux 10 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
| Rocky Linux 9 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) |
<!-- INSTALL_TABLE_END -->
...
|---|---|---|---:|---:|---:|---|
| [29712924802](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29712924802) | 2026-07-20 | `main@35a716c` | 9/9 | 8/9 | 8/9 | Debian 13 install, Ubuntu 26.04 runtime (runtime) |
| [29258581555](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29258581555) | 2026-07-13 | `main@05b5201` | 9/9 | 9/9 | 8/9 | Ubuntu 26.04 runtime (runtime) |
| [28750928446](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/28750928446) | 2026-07-05 | `main@33105d7` | 9/9 | 9/9 | 8/9 | Ubuntu 26.04 runtime (runtime) |
| [27914061978](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/27914061978) | 2026-06-21 | `main@7c23328` | 9/9 | 9/9 | 8/9 | Ubuntu 26.04 runtime (runtime) |
| [27768557082](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/27768557082) | 2026-06-18 | `main@c7867a1` | 9/9 | 8/9 | 8/9 | Debian 12 install, Ubuntu 26.04 runtime (runtime) |
<!-- HISTORY_SUMMARY_END -->
