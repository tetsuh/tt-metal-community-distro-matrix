...
**Last updated:** 2026-05-15 11:50 UTC
...
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Linux Mint 22.2 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Linux Mint 22.1 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Linux Mint 21.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([4 patches](patches/ubuntu/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Debian 13 | ❌(deps) | ✅ ([6 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Debian 12 | ❌(deps) | ✅ ([6 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Rocky Linux 10 | ✅ | ✅ ([1 patch](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Rocky Linux 9 | ✅ | ✅ ([1 patch](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Linux Mint 22.2 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Linux Mint 22.1 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Linux Mint 21.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Ubuntu 26.04 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Debian 13 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Debian 12 | ❌(install) (`v2.2.1`) | ❌(install) (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Rocky Linux 10 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
| Rocky Linux 9 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25914715257) |
<!-- INSTALL_TABLE_END -->
