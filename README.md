...
**Last updated:** 2026-07-12 19:31 UTC
**Tested tt-metal:** [`main@d933234`](https://github.com/tenstorrent/tt-metal/commit/d933234763127d0c0ec40f86f06d7ebf8b6026ab)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Linux Mint 22.2 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Linux Mint 22.1 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Linux Mint 21.3 | ✅ | ✅ ([2 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([3 patches](patches/ubuntu/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Debian 13 | ❌(deps) | ✅ ([2 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Debian 12 | ❌(deps) | ❌(deps) ([2 patches](patches/debian/)) | — | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Rocky Linux 10 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Rocky Linux 9 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Linux Mint 22.2 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Linux Mint 22.1 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Linux Mint 21.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Ubuntu 26.04 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Debian 13 | ✅ (`v2.2.1`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Debian 12 | — | — | — |
| Rocky Linux 10 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
| Rocky Linux 9 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) |
<!-- INSTALL_TABLE_END -->
...
|---|---|---|---:|---:|---:|---|
| [29204142411](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29204142411) | 2026-07-12 | `main@d933234` | 8/9 | 8/8 (1 unknown) | 7/8 (1 unknown) | Debian 12 build (deps), Ubuntu 26.04 runtime (runtime) |
