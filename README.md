...
**Tested tt-metal:** [`main@c464cb7`](https://github.com/tenstorrent/tt-metal/commit/c464cb750864ccaba58083723a4194989d540776)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Linux Mint 22.2 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Linux Mint 22.1 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Linux Mint 21.3 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([2 patches](patches/ubuntu/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Debian 13 | ❌(deps) | ✅ ([3 patches](patches/debian/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Debian 12 | ❌(deps) | ✅ ([3 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Rocky Linux 10 | ✅ | ✅ ([1 patch](patches/rocky/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Rocky Linux 9 | ✅ | ✅ ([1 patch](patches/rocky/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Linux Mint 22.2 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Linux Mint 22.1 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Linux Mint 21.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Ubuntu 26.04 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Debian 13 | ✅ (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Debian 12 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Rocky Linux 10 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
| Rocky Linux 9 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) |
<!-- INSTALL_TABLE_END -->
...
| [29850552122](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/29850552122) | 2026-07-21 | `main@679f6dd` | 9/9 | 9/9 | 9/9 | — |
<!-- HISTORY_SUMMARY_END -->
