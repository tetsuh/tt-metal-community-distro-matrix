...
**Tested tt-metal:** `main@a215b12`

| Distribution | Vanilla | With patches | Logs |
|---|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Linux Mint 22.2 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Linux Mint 22.1 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Linux Mint 21.3 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([3 patches](patches/ubuntu/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Debian 13 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Debian 12 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Rocky Linux 10 | ✅ | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Rocky Linux 9 | ✅ | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
<!-- COMPAT_TABLE_END -->
...
| Distribution | Vanilla | With patches | Logs |
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Linux Mint 22.2 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Linux Mint 22.1 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Linux Mint 21.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Ubuntu 26.04 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Debian 13 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Debian 12 | ❌(install) (`v2.2.1`) | ❌(install) (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
| Rocky Linux 10 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25433729633) |
...
This repository also provides a small [`ttsim`](https://github.com/tenstorrent/ttsim) smoke workflow for hardwareless execution coverage. It runs tt-metal's canonical LLK simulator smoke (`test_eltwise_unary_datacopy.py -k "Float16_b and not tilize"`) on a reference Ubuntu 22.04 host, using the simulator version pinned by the checked-out tt-metal tree.
