...
**Last updated:** 2026-05-14 13:58 UTC
**Tested tt-metal:** [`main@5895991`](https://github.com/tenstorrent/tt-metal/commit/58959914b35566efc8079a02add5428478adb30c)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | — (Python 3.12 != 3.10) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Linux Mint 22.2 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | — (Python 3.12 != 3.10) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Linux Mint 22.1 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | — (Python 3.12 != 3.10) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Linux Mint 21.3 | ✅ | ✅ ([1 patch](patches/linuxmint/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([3 patches](patches/ubuntu/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Debian 13 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Debian 12 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | ❌(runtime) (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Rocky Linux 10 | ✅ | ✅ (no patches) | — (Python 3.12 != 3.10) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Rocky Linux 9 | ✅ | ✅ (no patches) | — (Python 3.11 != 3.10) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Linux Mint 22.2 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Linux Mint 22.1 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Linux Mint 21.3 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Ubuntu 26.04 | ❌(install) (`v2.2.1`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Debian 13 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Debian 12 | ❌(install) (`v2.2.1`) | ❌(install) (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Rocky Linux 10 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
| Rocky Linux 9 | ✅ (`v2.2.1`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) |
<!-- INSTALL_TABLE_END -->
...
|---|---|---|---:|---:|---:|---|
| [25862255672](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/25862255672) | 2026-05-14 | `main@5895991` | 9/9 | 8/9 | 0/4 (5 unknown) | Debian 12 install, Linux Mint 21.3 runtime (runtime), Ubuntu 26.04 runtime (runtime), +2 more |
