...
**Last updated:** 2026-09-13 19:25 UTC
**Tested tt-metal:** [`main@03224d4`](https://github.com/tenstorrent/tt-metal/commit/03224d446cd102ec5f8acadf9bdf74f81d5fce56)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Linux Mint 22.2 | ❌(deps) | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Linux Mint 22.1 | ✅ | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Linux Mint 21.3 | ✅ | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([3 patches](patches/ubuntu/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Debian 13 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Debian 12 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Rocky Linux 10 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Rocky Linux 9 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Linux Mint 22.2 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Linux Mint 22.1 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Linux Mint 21.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Ubuntu 26.04 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Debian 13 | ✅ (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Debian 12 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Rocky Linux 10 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
| Rocky Linux 9 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) |
<!-- INSTALL_TABLE_END -->
...
|---|---|---|---:|---:|---:|---|
| [34774693006](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/34774693006) | 2026-09-13 | `main@03224d4` | 9/9 | 9/9 | 9/9 | — |
