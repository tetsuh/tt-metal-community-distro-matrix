...
**Last updated:** 2026-08-31 23:58 UTC
**Tested tt-metal:** [`main@047ec3c`](https://github.com/tenstorrent/tt-metal/commit/047ec3ccf96519a54c2a83b4ec2d2efc6f7ec258)

| Distribution | Vanilla | With patches | Runtime ttsim | Logs |
|---|:-:|:-:|:-:|---|
| Linux Mint 22.3 | ✅ | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Linux Mint 22.2 | ✅ | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Linux Mint 22.1 | ❌(deps) | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Linux Mint 21.3 | ✅ | ✅ ([3 patches](patches/linuxmint/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Ubuntu 26.04 | ❌(deps) | ✅ ([3 patches](patches/ubuntu/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Debian 13 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Debian 12 | ❌(deps) | ✅ ([5 patches](patches/debian/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Rocky Linux 10 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Rocky Linux 9 | ✅ | ✅ ([2 patches](patches/rocky/)) | ✅ (`risc-compute`) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
<!-- COMPAT_TABLE_END -->
...
|---|:-:|:-:|---|
| Linux Mint 22.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Linux Mint 22.2 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Linux Mint 22.1 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Linux Mint 21.3 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/linuxmint/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Ubuntu 26.04 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/ubuntu/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Debian 13 | ✅ (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Debian 12 | ❌(install) (`v3.4.0`) | ✅ ([1 patch](patches/debian/installer/)) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Rocky Linux 10 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
| Rocky Linux 9 | ✅ (`v3.4.0`) | ✅ (no patches) | [run](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) |
<!-- INSTALL_TABLE_END -->
...
|---|---|---|---:|---:|---:|---|
| [33448793198](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/33448793198) | 2026-08-31 | `main@047ec3c` | 9/9 | 9/9 | 9/9 | — |
| [32728422707](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/32728422707) | 2026-08-24 | `main@c464cb7` | 9/9 | 9/9 | 4/9 | Linux Mint 22.3 runtime (runtime), Ubuntu 26.04 runtime (runtime), Debian 13 runtime (runtime), +2 more |
| [31964583841](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/31964583841) | 2026-08-16 | `main@50a82f8` | 9/9 | 9/9 | 8/9 | Ubuntu 26.04 runtime (runtime) |
| [30761499636](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/30761499636) | 2026-08-02 | `main@98aaede` | 8/9 | 8/8 (1 unknown) | 8/8 (1 unknown) | Ubuntu 26.04 build (patch) |
| [30215113453](https://github.com/tetsuh/tt-metal-community-distro-matrix/actions/runs/30215113453) | 2026-07-26 | `main@9802b80` | 9/9 | 9/9 | 9/9 | — |
<!-- HISTORY_SUMMARY_END -->
